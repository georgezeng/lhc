...
CREATE TABLE `fx_sw4_yz` (
	...
	PRIMARY KEY (`id`),
	UNIQUE `uidx_fx_sw4_yz_date` (`date`)
);

CREATE TABLE `fx_sw5_yz` (
	`id` bigint(20) NOT NULL AUTO_INCREMENT,
	`year` int(11) NOT NULL,
	`phase` int(11) NOT NULL,
	`date` varchar(20) NOT NULL,
	...
	`zx18zf_nums` varchar(255),
	PRIMARY KEY (`id`),
	UNIQUE `uidx_fx_sw5_yz_date` (`date`)
);

CREATE TABLE `fx_sw6_yz` (
	`id` bigint(20) NOT NULL AUTO_INCREMENT,
	`year` int(11) NOT NULL,
	`phase` int(11) NOT NULL,
	`date` varchar(20) NOT NULL,
	...
	`zx18zf_nums` varchar(255),
	PRIMARY KEY (`id`),
	UNIQUE `uidx_fx_sw6_yz_date` (`date`)
);
