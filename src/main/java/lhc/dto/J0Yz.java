...
@SqlResultSetMapping(name = "J0Yz", classes = @ConstructorResult(targetClass = J0Yz.class, columns = {
		...
		@ColumnResult(name = "zszfj0", type = Integer.class), @ColumnResult(name = "wxj0", type = Integer.class),
		@ColumnResult(name = "wxzfj0", type = Integer.class), @ColumnResult(name = "wxdsj0", type = Integer.class),
