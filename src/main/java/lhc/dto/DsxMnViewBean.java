...
@SqlResultSetMapping(name = "DsxMn", classes = @ConstructorResult(targetClass = DsxMnViewBean.class, columns = {
...
@Entity
public class DsxMnViewBean extends DsxJyYz {
	public DsxMnViewBean() {
	}

	public DsxMnViewBean(String date, int year, int phase, Integer specialNum, String c1n, String c2n, String c3n,
			String c4n, String c5n, String c6n, String c7n, String c8n, String c9n, String c10n) {
