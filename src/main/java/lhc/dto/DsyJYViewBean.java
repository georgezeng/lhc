...
@SqlResultSetMapping(name = "DsyJY", classes = @ConstructorResult(targetClass = DsyJYViewBean.class, columns = {
...
@Entity
public class DsyJYViewBean extends DsyJyYz {
	public DsyJYViewBean() {
	}

	public DsyJYViewBean(String date, int year, int phase, Integer specialNum, String c1n, String c2n, String c3n, String c4n, String c5n, String c6n,
			String c7n, String c8n, String c9n, String c10n, String c11n) {
